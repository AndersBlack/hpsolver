...
// 	let new_node = make_node(new_problem.clone(), htn_subtask_queue, called, (Vec::<(String, i32, Vec<String>)>::new(),Vec::<(String, i32, Vec<String>, RelVars)>::new()), HashSet::<u64>::new());
...
// fn make_node( new_problem: Problem, sq: Vec::<(SubtaskTypes, RelVars)>, called: (Vec<bool>, Vec<(Method, RelVars)>, Vec<usize>), aal: (Vec<(String, i32, Vec<String>)>, Vec<(String, i32, Vec<String>, RelVars)>), hs: HashSet<u64>) -> Node {
...
// 		current_node.applied_action_list.1.push(("root".to_string(), method.id, Vec::<String>::new(), RelVars::new()));
...
// 		current_node.applied_action_list.1.push((method.name.clone(), method.id, Vec::<String>::new(), relevant_variables.clone()));
